        ...
        <div className="userDetails">
            ...
            <div className="userInfo">
                ...
                <div className="userListItem">
                    ...
                    <div className="userName"><strong>Phone:</strong> {user.phone}</div>
                    <div className="userName"><strong>Joining Date:</strong> {user.joiningDate}</div>
                    <div className="userName"><strong>Admission Fee:</strong> {user.admissionFee}</div>
                    <div className="userName"><strong>Total Months Paid:</strong> {paidCount} / {monthsDueCount}</div>
                </div>
            </div>
